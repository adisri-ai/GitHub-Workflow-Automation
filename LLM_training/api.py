"""
This is the main API for hosting the LLM
"""
...
#4. Re-inject empty adapters into the middle layer
...
# 5. Load PEFT weights (This maps saved LoRA AND CVPR adapter weights into the injected model)
...
import json
# Direct Function Test & JSON Evaluation
...
# FastAPI & Cloudflare Setup (Ngrok Alternative)
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from pydantic import BaseModel
from datetime import datetime
